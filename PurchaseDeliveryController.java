...
public class PurchaseDeliveryController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        PdProduct.setEntries(database.getSuggestionList("SELECT * FROM PURCHASE_ORDER;", "PRODUCT"));
        PdProduct.setEntries(database.getSuggestionList("SELECT * FROM SALE_ORDER;", "PRODUCT"));
        ...
        PdStorage.setEntries(database.getSuggestionList("SELECT * FROM PURCHASE_ORDER;", "STORAGE"));
        ...
        PdRateKg.setOnAction((ActionEvent evt) -> {
            ...
            if ("KG".equals(PdTypeDrop.getText())) {
                ...
                totalKg = IntegerTextField.doubleConvert(PdQuantity.getText()) * IntegerTextField.doubleConvert(PdUnit.getText()) * 37.32;
                PdRateMon.setText(IntegerTextField.numformat(rateMon));
                PdPrice.setText(IntegerTextField.numformat(totalKg * rateKg));
        ...
        PdRateMon.setOnAction((ActionEvent evt) -> {
            ...
            PdRateKg.setText(IntegerTextField.numformat(rateKg));
            PdPrice.setText(IntegerTextField.numformat(totalKg * rateKg));
        });
    ...
    private void generateDelivery(){
        ...
        String query="select MAX(PURCHASE_DELIVERY_ID) as ID from PURCHASE_DELIVERY;";
