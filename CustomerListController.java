...
public class CustomerListController implements Initializable {
    ...
    @FXML
    private TableColumn<CustomerTransactionDB, String> CtQuantityCol;
    @FXML
    private TableColumn<CustomerTransactionDB, String> CtUnitCol;
    @FXML
    ...
    @FXML
    private TableColumn<CustomerTransactionDB, String> CtProductCol;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        CtProductCol.setCellValueFactory(new PropertyValueFactory<>("product"));
        CtQuantityCol.setCellValueFactory(new PropertyValueFactory<>("quantity2"));
        CtUnitCol.setCellValueFactory(new PropertyValueFactory<>("unit2"));
